...
class PositionalEncoding(nn.Module):
    ...
    def __init__(self, d_model: int, seq_len: int, dropout: float) -> None:
        ...
        position = torch.arange(0, seq_len, dtype=torch.float).unsqueeze(1) # (seq_model, 1)
        # Create a vector of shape (d_model)
...
def build_transformer(src_vocab_size: int, 
    ...
    # Create the positional embeddings layers
...
if __name__ == '__main__':
    ...
    # Assuming you have defined the necessary classes like InputEmbeddings, PositionalEncoding, MultiHeadAttentionBlock, FeedForwardBlock, EncoderBlock, DecoderBlock, Encoder, Decoder, ProjectionLayer, and Transformer
